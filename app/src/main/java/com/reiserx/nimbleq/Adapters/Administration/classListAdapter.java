...
public class classListAdapter extends RecyclerView.Adapter<com.reiserx.nimbleq.Adapters.Administration.classListAdapter.ClassViewHolder> {
    ...
    @NonNull
    @Override
    public com.reiserx.nimbleq.Adapters.Administration.classListAdapter.ClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.class_list_layout, parent, false);
        return new com.reiserx.nimbleq.Adapters.Administration.classListAdapter.ClassViewHolder(view);
    }

    @SuppressLint({"SetTextI18n", "DefaultLocale"})
    @Override
    public void onBindViewHolder(@NonNull com.reiserx.nimbleq.Adapters.Administration.classListAdapter.ClassViewHolder holder, int position) {
